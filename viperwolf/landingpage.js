...
element.chrome.style.display = 'inline-block';
...
centerdiv = document.createElement('span');
element.chrome.appendChild(centerdiv);
centerdiv.style.position = 'absolute';
centerdiv.style.display = 'inline';
centerdiv.style.width = '60px';
centerdiv.style.height = '60px';
//centerdiv.style.zIndex = '999';
centerdiv.style.left = this.libraries.findPosX(element)+((element.width)/2)+"px";
centerdiv.style.top = this.libraries.findPosY(element)+((element.height)/2)+'px';
centerdiv.innerHTML = "";
...
loadPlayer: function(selector)
            {
            	...
            	if(element.play)
            	{
            		...
            		this.ViperVideo(element);
            		
            		if(element.getAttribute('viperwolf')=='landingpage')
            		{
            			console.log("Load Landing Page Viperwolf");
            			this.avatars.landingpage.action(element);
